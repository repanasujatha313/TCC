...
public class PreparePayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PreparePayment</title>");            
            out.println("</head>");
            out.println("<body>");
            boolean i=false;
            ...
            ResultSet rs=null;
            out.println("<b>payment will be prepared for approved requests..</b>");
            ...
            try{
                ...
                out.println("<tr><th>Consignment id</th><th>Consignment name</th><th>Consignment size</th><th>Destination distance</th><th>Status</th><th>DeliveryStatus</th><th>PaymentStatus</th><th>preparePayment</th></tr>");
                ...
                while(rs.next()){
                    ...
                    out.println("<tr><td>"+id+"</td><td>"+name+"</td><td>"+size+"</td><td>"+dist+"</td><td>"+st1+"</td><td>"+ds1+"</td><td>"+ps+"</td><td><a href=payment?Did="+dist+">proceed</a></td></tr>");
