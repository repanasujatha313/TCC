...
public class ViewDrivers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewDrivers</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                out.println("<tr><th>Driver id</th><th>Driver name</th><th>Driver password</th><th>Status</th></tr>");
                 while(rs.next()){
                    ...
                    out.println("<tr><td>"+id+"</td><td>"+n+"</td><td>"+p+"</td><td>"+s+"</td></tr>");
