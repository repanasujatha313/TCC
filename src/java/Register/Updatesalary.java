...
public class Updatesalary extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //lets consider salary of a driver per day 300/- 
            ...
            try{
                ...
                String s="insert into SalaryDb(Driverid,SalaryOfCurrentMonth)values(?,?)";
            ...
            try{
                ...
                con=(Connection) DriverManager.getConnection(url,userName,passWord);
                ps=(PreparedStatement) con.prepareStatement("select * from SalaryDb where Driverid='"+did+"'");
                rs=ps.executeQuery();
